...
def telegram_bot(token):
    ...
    def start(message):
        ...
        murkup.add(help_bt)
        bot.send_message(message.chat.id, mess, reply_markup=murkup)
...
Мы можем разместить до 10 человек(максимально)
    ...
    def photo_house(message):
        ...
        markup.add(narochguesthouse_by)
        photo_1 = open("../NarochBot/Bot/PhotoNarochBot/1.jpg", 'rb')
        photo_2 = open("../NarochBot/Bot/PhotoNarochBot/2.jpg", 'rb')
        photo_3 = open("../NarochBot/Bot/PhotoNarochBot/3.jpg", 'rb')
        photo_4 = open("../NarochBot/Bot/PhotoNarochBot/4.jpg", 'rb')
        photo_5 = open("../NarochBot/Bot/PhotoNarochBot/5.jpg", 'rb')
        photo_6 = open("../NarochBot/Bot/PhotoNarochBot/6.jpg", 'rb')
        photo_7 = open("../NarochBot/Bot/PhotoNarochBot/7.jpg", 'rb')
        photo_8 = open("../NarochBot/Bot/PhotoNarochBot/8.jpg", 'rb')
        photo_9 = open("../NarochBot/Bot/PhotoNarochBot/9.jpg", 'rb')
        photo_10 = open("../NarochBot/Bot/PhotoNarochBot/10.jpg", 'rb')
